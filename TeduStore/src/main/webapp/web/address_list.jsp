	...
	<div class="rightsidebar_box rt">	
		...
		<div class="address_list">
			...
			<div class="buttons-block">
				<a href="#" onclick="showPopup(0)" class="button-blue">新增收货地址</a>
			</div>
		</div>
	</div>
</div>
...
<div id="popup_content">
	...
	<form id="address-form" method="post" action="">
		...
		<div data-toggle="distpicker" class="address_content">
			...
			<select name="recvProvince" data-province="---- 选择省 ----" id="recvProvince" onchange="getCities(-1,-1)" style="width: 130px;"></select>
			城市：<select name="recvCity" data-city="---- 选择市 ----" id="recvCity" onchange="getAreas(-1)" style="width: 130px;"></select>
			区/县：<select name="recvArea" data-district="---- 选择区 ----" id="recvArea" style="width: 130px;"></select>
		</div> 
		<!--收货人详细地址-->
		<div class="address_particular">
			<span class="red">*</span>
			<span class="kuan">详细地址：</span>&nbsp;
			<textarea name="recvAddr" id="recvAddr" 
		...
		<div class="address_tel">
			...
			固定电话：<input type="text" name="recvTel" id="recvTel"/>
		</div>
		<!--邮政编码-->
		...
		<!--保存收货人信息-->
		<div class="bu|ttons-block">
			<input type="hidden" name="id" id="id">
	          	<a href="#" onclick="postForm()" class="button-blue">保存收货人信息</a>
	          	<!-- 取消按钮 -->
...
<script type="text/javascript">
// 地址列表中每条数据的模板(带有特殊字符用户占位的HTML代码)
...
function postForm(){
	// 获取隐藏域中设置的Id值
	var id = $("#id").val();
	// 根据id确定当前是"新增"还是"修改"，从而决定数据提交到哪个路径
