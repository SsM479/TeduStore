			...
			<div class="rs_content">
				<form id="user-profile">
					...
					<div class="rs_content_username">
						...
						<input id="username" name="username" class="ed_username"
							style="display: none;" /> <span
							class="change_username same_click">更改用户名</span>
					</div>
					<!--性别-->
					<div class="rs_content_sex">
						<span class="same">性别：</span> <input type="radio"
							<c:if test="${user.gender == 1 }">
                	checked="checked" 
                	</c:if>
							name="gender" id="gender_male" value="1" />男 <input type="radio"
							<c:if test="${user.gender == 0 }">
                	checked="checked" 
                	</c:if>
							name="gender" id="gender_female" value="0" />女
					...
					<div class="rs_content_mail">
						...
						<input id="email" name="email" class="ed_email" style="display: none;" /> <span class="rs_mail">${user.email }</span>
