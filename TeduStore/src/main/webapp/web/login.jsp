    ...
    <div id="cover" class="rt">
        <form id="login-form" method="post" name="form1">
            <div class="txt">
                ...
                <div class="text">
                	<input type="text" id="code" placeholder="请输验证码" name="code" required minlength="4" maxlength="4" />
                	<span><img id="codeImg" alt="" src="code.do" style="top: -38px;right: -168px;" ></span>
                </div>
...
//页面加载完成后，判断在Cookie中是否有"自动登录"相关信息
